...
public final class ItemTransactionBinding implements ViewBinding {
  ...
  private ItemTransactionBinding(@NonNull MaterialCardView rootView,
      @NonNull MaterialCardView cvIcon, @NonNull TextView tvAmount, @NonNull TextView tvCategory,
  ...
  public static ItemTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cv_icon;
      MaterialCardView cvIcon = ViewBindings.findChildViewById(rootView, id);
      if (cvIcon == null) {
        break missingId;
      }
      ...
      return new ItemTransactionBinding((MaterialCardView) rootView, cvIcon, tvAmount, tvCategory,
          tvDate, tvIcon, tvNote);
    }
